...
const inputSchema = z.object({
  ...
  note_path: z
    ...
    .describe(
      ...
      '⚠️ If the user specifies ANY deadline, duration, end date, or completion date for a task (e.g. "before...", "by...", "within...", "finish by...", "complete before..."), the task MUST be treated as spanning an active period. The active period starts from the resolved start date (normally today unless explicitly specified otherwise) and ends at the resolved deadline/end date. The filename MUST use the resolved date range. Examples: "2026-08-22-25-kunming-trip", "2026-07-20-22-submit-report", "2026-08-05-2026-09-09-finish-asdea", "2026-08-05-15-renew-passport", or "2026-08-30-2026-09-02-business-trip". ' +
      'Do NOT use vague or ambiguous names like "today", "tomorrow", "note", or "untitled" — use a descriptive name that reflects the content. ' +
